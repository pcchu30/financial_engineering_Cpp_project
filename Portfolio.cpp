 ...
 * and only having the implementation in the C++ file we increase
 * information hiding. Nobody knows about the PortfolioImpl class 
 * outside of the C++ file, so we can change it without any impact 
 * on anything else.
 */
